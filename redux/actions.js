...
export const getInfoThunk = () => (dispatch) => {
  return PhotoGalleryApi.getInfo()
    .then(res => {
...
export const setImageThunk = (image) => (dispatch) => {
  ...
  return PhotoGalleryApi.setNewImage(data)
    .then((res) => {
...
export const setInfoThunk = (info) => (dispatch) => {
  return PhotoGalleryApi.setInfo(info)
    .then(res => {
...
export const deleteAllThunk = (data) => (dispatch) => {
  return PhotoGalleryApi.deleteAllImages(data)
    .then(() => dispatch(deleteAllImages()))
}

export const deleteByIdThunk = (id) => (dispatch) => {
  return PhotoGalleryApi.deleteImageById(id)
    .then(() => dispatch(deleteById(id)))
};